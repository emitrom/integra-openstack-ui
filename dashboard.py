...
class Providers(horizon.PanelGroup):
    slug = "providers"
    name = _("Providers")
    panels = ('list_providers', 'add_provider', 'remove_provider', 'wp', 'providers')

class Workflows(horizon.PanelGroup):
    slug = "workflows"
    name = _("Workflows")
    panels = ('list_workflows', 'add_workflow', 'remove_workflow', 'workflows')

class Schedules(horizon.PanelGroup):
    slug = "schedules"
    name = _("Schedules")
    panels = ('list_schedules', 'add_schedule', 'remove_schedule', 'schedules')
